...
void VVintage8bitWorker::process() {
    try {
        ...
        videoUtils::checkCudaError(cudaMalloc(&d_colorsBGR, 9 * sizeof(char)), "Failed to allocate device memory for image");
        ...
        while (video.getSuccess()) {
            ...
            vintage8bit(
                ...
                d_img, m_pixelWidth, m_pixelHeight, m_thresh, d_colorsBGR, 3,
