...
OutlineWorker::OutlineWorker(int shiftX, int shiftY, QObject* parent)
	: VideoEffect(parent), m_shiftX(shiftX), m_shiftY(shiftY)
{}

void OutlineWorker::process() {
    try {
        ...
        // Extract audio
        extractAudio(m_inputPath, temp_audio_name);
        ...
        mergeAudio(temp_video_name, temp_audio_name, m_outputPath);
